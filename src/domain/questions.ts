...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    id: 3,
    axis: 'spend',
    text: '세일 중인 옷을 발견했을 때 나는 어떻게 할까',
    options: [
  ...
  },
  {
    id: 4,
    axis: 'spend',
    text: '카페에서 음료를 고를 때 나는 어떤 기준으로 골까',
    options: [
  ...
  },
  {
    id: 7,
    axis: 'plan',
    text: '이번 달 지출을 기록하고 관리하고 있는 편인가',
    options: [
  ...
  },
  {
    id: 11,
    axis: 'risk',
    text: '투자한 곳에서 손실이 났을 때 나는 어떻게 할까',
    options: [
  ...
  },
  {
    id: 12,
    axis: 'risk',
    text: '새로운 재테크 상품이 나오면 나는 어떻게 반응할까',
    options: [
